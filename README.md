...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/broken-forest-c267
```

A live public deployment of this template is available at [https://broken-forest-c267.templates.workers.dev](https://broken-forest-c267.templates.workers.dev)
